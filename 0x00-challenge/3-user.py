...
if __name__ == '__main__':
    ...
    try
      ...
      assert False, "User.password should be None if setter to None"
    ...
    try
      ...
      assert False, "User.password should be None if setter to an integer"
    assert user_1.is_valid_password(u_pwd), "is_valid_password should return True if it's the right \
  password"
    assert not user_1.is_valid_password("Fakepwd"), "is_valid_password should return False if it's \
